...
"	014	03-Sep-2013	Factor out ExtractMatches#YankMatches() to yank
"				into a List without all the user messages.
"				This is useful for reuse by other plugins.
...
function! ExtractMatches#YankMatches( firstLine, lastLine, pattern, replacement, isOnlyFirstMatch, isUnique )
"******************************************************************************
"* PURPOSE:
...
"****D echomsg '****' string(l:pattern) string(l:replacement) string(l:register)
    ...
    let l:matches = ExtractMatches#YankMatches(a:firstLine, a:lastLine, l:pattern, l:replacement, a:isOnlyFirstMatch, a:isUnique)
